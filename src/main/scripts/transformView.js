...
//                console.log('[2] text.empty():', d, text.empty(),drawGraphElements.linkHasText(d));
                ...
                var ar = hasDirection(d) ? arrowSize : 0;
                var rotatedPointA1 = rotatePoint(center, {x: 0 + (nodeRadius + 1) * u.x - n.x, y: 0 + (nodeRadius + 1) * u.y - n.y}, angle),
                        ...
                        rotatedPointB2 = rotatePoint(center, {x: d.target.x - d.source.x - (nodeRadius + 2) * u.x - n.x - u.x * ar, y: d.target.y - d.source.y - (nodeRadius + 2) * u.y - n.y - u.y * ar}, angle),
                        rotatedPointC2 = rotatePoint(center, {x: d.target.x - d.source.x - (nodeRadius + 2) * u.x - n.x + (n.x - u.x) * ar, y: d.target.y - d.source.y - (nodeRadius + 2) * u.y - n.y + (n.y - u.y) * ar}, angle),
                        ...
                        rotatedPointE2 = rotatePoint(center, {x: d.target.x - d.source.x - (nodeRadius + 2) * u.x + (-n.x - u.x) * ar, y: d.target.y - d.source.y - (nodeRadius + 2) * u.y + (-n.y - u.y) * ar}, angle),
                        rotatedPointF2 = rotatePoint(center, {x: d.target.x - d.source.x - (nodeRadius + 2) * u.x - u.x * ar, y: d.target.y - d.source.y - (nodeRadius + 2) * u.y - u.y * ar}, angle),
